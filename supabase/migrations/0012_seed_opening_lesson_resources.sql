...
cross join (
  values
    ...
    (
      ...
      'rnb1kbnr/pppp1ppp/8/4p3/6q1/5N2/PPPPPPPP/RNBQKB1R w KQkq - 1 3',
      '["Nxh4"]',
      'Use a developing move that also wins material.',
...
cross join (
  values
    ...
    (
      ...
      '{"fen":"rnb1kbnr/pppp1ppp/8/4p3/6q1/5N2/PPPPPPPP/RNBQKB1R w KQkq - 1 3","solution":["Nxh4"]}',
      25,
      125,
      7,
      true
